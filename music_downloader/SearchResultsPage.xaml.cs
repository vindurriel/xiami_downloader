...
namespace music_downloader
{
    ...
    /// </summary>
    public sealed partial class SearchResultsPage : music_downloader.Common.LayoutAwarePage, IHandle<MsgSearchStateChanged>
    {
        MusicViewModelList results = new MusicViewModelList();
        ...
        /// </summary>
        private sealed class Filter : music_downloader.Common.BindableBase
        {
        ...
        public void Handle(MsgSearchStateChanged message)
        {
            switch (message.State)
            {
                ...
                case EnumSearchState.Working:
                    results.AddItems(message.SearchResult.Items);
                    break;
