    ...
    sealed partial class App : Application
    {
        ...
        protected async override void OnSearchActivated(Windows.ApplicationModel.Activation.SearchActivatedEventArgs args)
        {
            ...
            if (frame == null)
            {
                ...
                frame = new Frame();
                music_downloader.Common.SuspensionManager.RegisterFrame(frame, "AppFrame");
                ...
                if (args.PreviousExecutionState == ApplicationExecutionState.Terminated)
                {
                    ...
                    try
                    {
                        await music_downloader.Common.SuspensionManager.RestoreAsync();
                    }
                    catch (music_downloader.Common.SuspensionManagerException)
                    {
                        //还原状态时出现问题。
                        //假定没有状态并继续
                    }
