...
namespace Jean_Doe.MusicControl
{
    public class VirtualizingWrapPanel : VirtualizingPanel, IScrollInfo
    {
        ...
        public WrapPanelAbstraction AbstractPanel { get { return _abstractPanel; } }
        ...
        public static readonly DependencyProperty ItemHeightProperty = DependencyProperty.Register("ItemHeight", typeof(double), typeof(VirtualizingWrapPanel), new FrameworkPropertyMetadata(1000.0));
        public static readonly DependencyProperty ItemWidthProperty = DependencyProperty.Register("ItemWidth", typeof(double), typeof(VirtualizingWrapPanel), new FrameworkPropertyMetadata(1000.0));
        ...
        private void ComputeExtentAndViewport(Size pixelMeasuredViewportSize, int visibleSections)
        {
            ...
            if (Orientation == Orientation.Horizontal)
            {
                _extent.Height = ItemHeight * _abstractPanel.SectionCount; //_abstractPanel.SectionCount + ViewportHeight - 1;

            }
            else
            {
                _extent.Width = ItemWidth * _abstractPanel.SectionCount;  //_abstractPanel.SectionCount + ViewportWidth - 1;
            }
        ...
        protected override Size MeasureOverride(Size availableSize)
        {
            ...
            //if (lastVisibleSections > visibleSections)
            //    visibleSections = lastVisibleSections;
            ComputeExtentAndViewport(availableSize, visibleSections);
            lastVisibleSections=visibleSections;

            return availableSize;
        }
        int lastVisibleSections = -1;
        ...
        public class WrapPanelAbstraction : IEnumerable<ItemAbstraction>
        {
