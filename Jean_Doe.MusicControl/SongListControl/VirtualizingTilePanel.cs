...
namespace Jean_Doe.MusicControl
{
    class VirtualizingTilePanel : VirtualizingPanel, IScrollInfo
    {
        ...
        public static readonly DependencyProperty ChildWidthProperty =
            DependencyProperty.Register("ChildWidth", typeof(double), typeof(VirtualizingTilePanel), new PropertyMetadata(200.0));
        ...
        public static readonly DependencyProperty ChildHeightProperty =
            DependencyProperty.Register("ChildHeight", typeof(double), typeof(VirtualizingTilePanel), new PropertyMetadata(200.0));
